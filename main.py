...
class CarRacing:
    ...
    def initialize(self):
        ...
        self.carImg = pygame.image.load('.\\img\\car3.png')
        self.car_x_coordinate = (self.display_width * 0.45)
        self.car_y_coordinate = (self.display_height * 0.8)
        self.car_width = 49

        # enemy_car
        self.enemy_car = pygame.image.load('.\\img\\car4.png')
        ...
        # Background
        self.bgImg = pygame.image.load(".\\img\\road1.jpg")
    ...
    def display_credit(self):
        ...
        text = font.render("Iqbal Hasan Khan", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("iqbalniloy0@gmail.com", True, self.white)
